function showGuide() {
  ...
  window.location.href = `genshin-payment.html?${query}`;
}
  ...
  document.getElementById("proceedBtn").addEventListener("click", function () {
    ...
    if (playerId === "") {
      document.getElementById("error-player").textContent = "Please enter Player UID";
      document.getElementById("error-player").style.display = "block";
      error = true;
    }

    if (serverId === "") {
      document.getElementById("error-server").textContent = "Please enter Server";
      document.getElementById("error-server").style.display = "block";
      error = true;
    }

    if (!selectedCard) {
      document.getElementById("error-diamond").textContent = "Please choose Genesis Crystal amount";
